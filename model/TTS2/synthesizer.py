...
from model.TTS2.hparams import hparams
from model.TTS2.tacotron2 import create_model, get_most_recent_checkpoint
from model.TTS2.utils.audio import save_wav, inv_linear_spectrogram, inv_preemphasis, inv_spectrogram_tensorflow
from model.TTS2.utils import PARAMS_NAME, load_json, load_hparams, add_prefix, add_postfix, get_time, parallel_run, makedirs, \
    str2bool

# from text.korean import tokenize
from model.TTS2.text import text_to_sequence, sequence_to_text
from model.TTS2.utils.pad import _prepare_inputs
import warnings
...
def main(text):
    ...
    parser.add_argument('--load_path', default="./model/TTS2/ckpt")
    parser.add_argument('--sample_path', default="output")
    ...
    audio = synthesizer.synthesize(texts=text, base_path=config.sample_path, speaker_ids=[config.speaker_id],
