...
hparams = tf.contrib.training.HParams(
    ...
    skip_path_filter = True, # npz파일에서 불필요한 것을 거르는 작업을 할지 말지 결정. receptive_field 보다 짧은 data를 걸러야 하기 때문에 해 줘야 한다.
    use_lws = False,
    ...
    silence_threshold = 2,             # Volume threshold below which to trim the start and the end from the training set samples. e.g. 2
